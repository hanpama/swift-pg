...
def main():
    ...
    with open("Sources/SwiftPG/DatabaseError.swift", "w") as f:
        f.write("// This file is generated from Tools/gen_errcodes.py\n")
        f.write("// Do not edit this file directly.\n")

        f.write("public enum DatabaseError: Swift.Error {\n")
